...
def getHouseInfo(ss):
    ...
    for houseInfoUrl in houseInfoUrlList:
        ...
        # print(contentInfo[0])
        sql_2 = """
                INSERT IGNORE INTO houseSpider (xiangmuming,fangwuzuoluo,fanghao,zhuanghao,jianzhumianji,jiegou,fentanmianji,taoneimianji,suozaiceng,yongtu,zhuangxiu,huxing)VALUES('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}' )
                    """ \
            .format(
...
if __name__=='__main__':
    ...
    start_ = time.time()
        ...
        # try:
    for i in range(5,10):#130
        # ok 1-1000 2-1169 3-1085 4-1351 表格
        # mysql 4-1351 5-815 6-886 7-1969 8-1935
        getHouseInfo(i)
        # except:
        #     with open('log.txt', 'a', encoding='utf-8') as f:
        #         content = "没有完成:%s" % (str(i))
        #         print(content)
        #         f.write(str(content) + '\n')
        #         f.close()
    end_ = time.time()
